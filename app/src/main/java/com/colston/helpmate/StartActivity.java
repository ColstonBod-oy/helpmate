...
public class StartActivity extends AppCompatActivity {
  ...
  private static final String[] ANDROID_12_BLE_PERMISSIONS =
      new String[] {
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
      ...
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
        ActivityCompat.requestPermissions(
            this, ANDROID_12_BLE_PERMISSIONS, BLUETOOTH_PERMISSIONS_REQUEST_CODE);
      }
  ...
  public void onRequestPermissionsResult(
    ...
    if (requestCode == LOCATION_PERMISSIONS_REQUEST_CODE) {
      ...
      if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
        ...
        Toast.makeText(StartActivity.this, "Location Permissions Granted", Toast.LENGTH_SHORT)
            .show();
      } else {
        Toast.makeText(StartActivity.this, "Location Permissions Denied", Toast.LENGTH_SHORT)
            .show();
      }
    } else if (requestCode == BLUETOOTH_PERMISSIONS_REQUEST_CODE) {
      if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
        Toast.makeText(StartActivity.this, "Bluetooth Permissions Granted", Toast.LENGTH_SHORT)
            .show();
      } else {
        Toast.makeText(StartActivity.this, "Bluetooth Permissions Denied", Toast.LENGTH_SHORT)
            .show();
      }
    } else if (requestCode == RECORD_AUDIO_PERMISSION_REQUEST_CODE) {
      if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
        Toast.makeText(StartActivity.this, "Record Audio Permission Granted", Toast.LENGTH_SHORT)
            .show();
      } else {
        Toast.makeText(StartActivity.this, "Record Audio Permission Denied", Toast.LENGTH_SHORT)
            .show();
      }
    }
  }
